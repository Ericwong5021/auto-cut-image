...
1. Run `multica issue get b714fb4d-38ee-4202-a4f9-887098d5c3ef --output json` to understand the issue context
2. Run `multica issue metadata list b714fb4d-38ee-4202-a4f9-887098d5c3ef --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. 2 new comment(s) on this issue since your last run — don't read them all blindly. Start with the thread your triggering comment is in: `multica issue comment list b714fb4d-38ee-4202-a4f9-887098d5c3ef --thread 1a035861-059c-4110-925e-8774f2e14779 --since 2026-06-04T23:22:55Z --output json` (swap `--since` for `--tail 30` if you need the full thread, not just the delta). Only if you need context from the other threads, catch up issue-wide: `multica issue comment list b714fb4d-38ee-4202-a4f9-887098d5c3ef --since 2026-06-04T23:22:55Z --output json`.

4. Find the triggering comment (ID: `1a035861-059c-4110-925e-8774f2e14779`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    cat <<'COMMENT' | multica issue comment add b714fb4d-38ee-4202-a4f9-887098d5c3ef --parent 1a035861-059c-4110-925e-8774f2e14779 --content-stdin
    First paragraph.
